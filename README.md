...
En este repositorio te dejo el código realizado en nuestra sesión en vivo en donde aprendimos las bases de NodeJS y cómo podemos utilizar este genial runtime de Javascript fuera del navegador.

El código que ves aquí es el mismo que escribo en [este video](https://youtu.be/uqeoxHIn5zI) en YouTube. Espero le puedas sacar un buen uso.
